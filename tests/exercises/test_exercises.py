...
class TestExercises:
    ...
    def test_get_exercise(
        ...
        # Отправляем GET-запрос на получение ранее созданного в function_exercise задания
        ...
        assert_status_code(response.status_code, HTTPStatus.OK)
        # Проверяем, что данные задания соответствуют данным ранее созданного задания
    ...
    def test_update_exercise(
        ...
        # Формируем запрос обновления задания
        request = UpdateExerciseRequestSchema()
        # Отправляем запрос на обновление ранее созданного в function_exercise задания
    ...
    def test_get_exercises(
        ...
        # Формируем параметры запроса, передавая course_id из function_course
